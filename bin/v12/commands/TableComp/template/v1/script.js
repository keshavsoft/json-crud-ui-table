...
async function ensureKSTableComp() {
    ...
    async function tryGitHub() {
        try {
            const fromPromise = await loadScriptAsModule("https://keshavsoft.github.io/tailwind-table-dom-comp/Public/v3/kstable.js");

            console.log("KSTableComp loaded from git : tailwind-table-dom-comp-3");
